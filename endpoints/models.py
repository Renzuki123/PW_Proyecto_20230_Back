...
class Restaurante(models.Model):
    ...
    category = models.ForeignKey(CategoriaRestaurante, on_delete=models.CASCADE, null=True)
...
class Plato(models.Model):
    ...
    category = models.ForeignKey(CategoriaPlato, on_delete=models.CASCADE, null=True)
    img = models.URLField()
